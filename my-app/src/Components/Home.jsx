...
import TutorialReactQuery from './TutorialReactQuery';

const user = {
  name: 'Tom Cook',
  email: 'tom@example.com',
  imageUrl: 'https://avatars.githubusercontent.com/u/88848572?s=40&v=4',
};
const navigation = [
...
export default function Home() {
  const [togglePokemonView, setTogglePokemonView] = useState(false);
                    ...
                    <div className="flex items-center justify-between h-16 px-4 sm:px-0">
                      ...
                      <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                          <button
                            onClick={() =>
                              setTogglePokemonView(!togglePokemonView)
                            }
                            type="button"
